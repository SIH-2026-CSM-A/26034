...
import type { DailyBucket } from '../../fixtures/dashboard';
    ...
    <section className="bg-white border border-slate-200 rounded-xl p-4 shadow-xs">
      ...
      <div className="space-y-2.5">
        {timeline.map((bucket) => {
          ...
          const passPct = (bucket.passCount / total) * 100;
          const reviewPct = (bucket.reviewCount / total) * 100;
          const violPct = (bucket.potentialViolationCount / total) * 100;
