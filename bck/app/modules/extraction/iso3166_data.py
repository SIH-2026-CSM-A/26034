"""ISO 3166-1 country dataset and lookup maps for Country of Origin extraction.

Source provenance: Standard ISO 3166-1 dataset derived from system iso-codes.
Contains exactly 249 official ISO 3166-1 country records.
"""

from typing import Final

ISO_3166_1_RECORDS: Final[list[dict[str, str]]] = [
    ...
    {"name": "Antarctica", "alpha_2": "AQ", "alpha_3": "ATA"},
    ...
    {"name": "Bouvet Island", "alpha_2": "BV", "alpha_3": "BVT"},
    {"name": "Brazil", "alpha_2": "BR", "alpha_3": "BRA"},
    {"name": "British Indian Ocean Territory", "alpha_2": "IO", "alpha_3": "IOT"},
    ...
    {"name": "Cabo Verde", "alpha_2": "CV", "alpha_3": "CPV"},
    ...
    {"name": "Christmas Island", "alpha_2": "CX", "alpha_3": "CXR"},
    {"name": "Cocos (Keeling) Islands", "alpha_2": "CC", "alpha_3": "CCK"},
    ...
    {"name": "Curaçao", "alpha_2": "CW", "alpha_3": "CUW"},
    {"name": "Cyprus", "alpha_2": "CY", "alpha_3": "CYP"},
    {"name": "Czechia", "alpha_2": "CZ", "alpha_3": "CZE"},
    {"name": "Côte d'Ivoire", "alpha_2": "CI", "alpha_3": "CIV"},
    ...
    {"name": "Eswatini", "alpha_2": "SZ", "alpha_3": "SWZ"},
    ...
    {"name": "French Southern Territories", "alpha_2": "TF", "alpha_3": "ATF"},
    ...
    {"name": "Heard Island and McDonald Islands", "alpha_2": "HM", "alpha_3": "HMD"},
    ...
    {"name": "Libya", "alpha_2": "LY", "alpha_3": "LBY"},
    ...
    {"name": "North Macedonia", "alpha_2": "MK", "alpha_3": "MKD"},
    ...
    {"name": "Palestine, State of", "alpha_2": "PS", "alpha_3": "PSE"},
    ...
    {"name": "Réunion", "alpha_2": "RE", "alpha_3": "REU"},
    {"name": "Saint Barthélemy", "alpha_2": "BL", "alpha_3": "BLM"},
    ...
    {"name": "South Georgia and the South Sandwich Islands", "alpha_2": "GS", "alpha_3": "SGS"},
    ...
    {"name": "Taiwan, Province of China", "alpha_2": "TW", "alpha_3": "TWN"},
    ...
    {"name": "Türkiye", "alpha_2": "TR", "alpha_3": "TUR"},
    ...
    {"name": "United States Minor Outlying Islands", "alpha_2": "UM", "alpha_3": "UMI"},
    ...
    {"name": "Åland Islands", "alpha_2": "AX", "alpha_3": "ALA"},
]

# Fast runtime lookup maps (O(1) indexing)
CANONICAL_NAME_MAP: Final[dict[str, dict[str, str]]] = {
    rec["name"].lower(): rec for rec in ISO_3166_1_RECORDS
}

ALPHA2_MAP: Final[dict[str, dict[str, str]]] = {
    rec["alpha_2"].upper(): rec for rec in ISO_3166_1_RECORDS
}

ALPHA3_MAP: Final[dict[str, dict[str, str]]] = {
    rec["alpha_3"].upper(): rec for rec in ISO_3166_1_RECORDS
}

COMMON_VARIANTS: Final[dict[str, str]] = {
    "usa": "United States",
    "u.s.a.": "United States",
    "uk": "United Kingdom",
    "u.k.": "United Kingdom",
